...
window.SegueI18n = (function () {
  ...
  const de = {
    ...
    "common.audio": "Audio",
    "common.dataReceived": "Datenvolumen",
    "common.mono": "Mono",
    ...
    "admin.eventName.label": "Event:",
    "admin.eventName.placeholder": "kein Eventname gesetzt",
    "admin.djs.title": "DJs",
    ...
    "admin.roster.schedule.running": "Läuft:",
    "admin.roster.schedule.until": "bis",
    "admin.roster.chat.placeholder": "Nachricht an {username}…",
    "admin.roster.chat.show": "Nachrichten",
    "admin.roster.chat.hide": "Nachrichten ausblenden",
    "admin.roster.chat.empty": "Noch keine Nachrichten.",
    "admin.roster.chat.you": "Du",
    "admin.roster.chat.dj": "DJ",
    "admin.roster.chat.acked": "bestätigt",
    "admin.roster.chat.notAcked": "noch nicht bestätigt",
  ...
  const en = {
    ...
    "common.bitrate": "Bitrate",
    "common.audio": "Audio",
    "common.dataReceived": "Data received",
    "common.mono": "Mono",
    "common.stereo": "Stereo",
    "common.delay": "Delay DJ→server",
    ...
    "admin.eventName.label": "Event:",
    "admin.eventName.placeholder": "no event name set",
    "admin.djs.title": "DJs",
    ...
    "admin.roster.schedule.running": "Running:",
    "admin.roster.schedule.until": "until",
    "admin.roster.chat.placeholder": "Message to {username}…",
    "admin.roster.chat.show": "Messages",
    "admin.roster.chat.hide": "Hide messages",
    "admin.roster.chat.empty": "No messages yet.",
    "admin.roster.chat.you": "You",
    "admin.roster.chat.dj": "DJ",
    "admin.roster.chat.acked": "confirmed",
    "admin.roster.chat.notAcked": "not confirmed yet",
    "admin.admins.title": "Admins",
    "admin.admins.intro":
